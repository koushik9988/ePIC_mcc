...
#img = ax.imshow(np.log10(hist2d), extent=extent, origin='lower', interpolation= 'bilinear', aspect='auto', cmap='plasma')
img = ax.imshow(hist2d, extent=extent, origin='lower', interpolation= 'bilinear', aspect='auto', cmap='plasma')
