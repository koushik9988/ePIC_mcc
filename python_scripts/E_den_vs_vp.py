...
efield_norm = (n0 * 1.602176565e-19 * LDi) / 8.85418782E-12
...
plt.figure()
#plt.scatter(v_ph_array, E2_array / np.max(E2_array), s=30, color='dodgerblue', edgecolors='k', alpha=0.8)
